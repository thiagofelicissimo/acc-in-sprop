...
Definition sigmaTy_HO (n : nat) (A : ZFSet -> ZFSet) (B : ZFSet -> ZFSet -> ZFSet) : ZFSet -> ZFSet :=
...
Proof.
  apply setPairβ1'. now apply (sigmaTy_HO_typing n (Γ := Γ)).
Qed.

Lemma hd_sigmaTy {n : nat} {Γ γ : ZFSet} {A : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n) (Hγ : γ ∈ Γ) :
  𝕌hd n (sigmaTy_HO n A B γ) ≡ ZFtwo.
Proof.
  refine (trans (fequal (setFstPair ω (𝕍 n)) _) _).
  apply setPairβ2'. now apply (sigmaTy_HO_typing n (Γ := Γ)).
  apply setPairβ1. apply two_typing. now apply (typeTelescope2_typing n (Γ := Γ)).
Qed.  

Lemma lbl_sigmaTy {n : nat} {Γ γ : ZFSet} {A : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n) (Hγ : γ ∈ Γ) :
  𝕌lbl n (sigmaTy_HO n A B γ) ≡ typeTelescope2 n A B γ.
Proof.
  refine (trans (fequal (setSndPair ω (𝕍 n)) _) _).
  apply setPairβ2'. now apply (sigmaTy_HO_typing n (Γ := Γ)).
  apply setPairβ2. apply two_typing. now apply (typeTelescope2_typing n (Γ := Γ)).
Qed.
...
Lemma dom_sigmaTy_eq {n : nat} {Γ γ : ZFSet} {A : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n) (Hγ : γ ∈ Γ) :
...
Lemma cod_sigmaTy_eq {n : nat} {Γ γ : ZFSet} {A : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n) (Hγ : γ ∈ Γ) :
  cod_sigmaTy n (sigmaTy_HO n A B γ) ≡ typeToGraph n (A γ) (B γ).
Proof.
...
Lemma sigmaTy_HO_inj1 (n : nat) {Γ γ : ZFSet} {A A' : ZFSet -> ZFSet} {B B' : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n)
  (HA' : ∀ γ ∈ Γ, A' γ ∈ 𝕌 n) (HB' : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A' γ), B' γ a ∈ 𝕌 n)
...
Lemma sigmaTy_HO_inj2' (n : nat) {Γ γ : ZFSet} {A A' : ZFSet -> ZFSet} {B B' : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n)
  (HA' : ∀ γ ∈ Γ, A' γ ∈ 𝕌 n) (HB' : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A' γ), B' γ a ∈ 𝕌 n)
  (Hγ : γ ∈ Γ) (H : sigmaTy_HO n A B γ ≡ sigmaTy_HO n A' B' γ) :
  typeToGraph n (A γ) (B γ) ≡ typeToGraph n (A γ) (B' γ).
Proof.
  pose proof (sigmaTy_HO_inj1 n HA HB HA' HB' Hγ H) as HAA'.
...
Lemma sigmaTy_HO_inj2 (n : nat) {Γ γ a : ZFSet} {A A' : ZFSet -> ZFSet} {B B' : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n)
  (HA' : ∀ γ ∈ Γ, A' γ ∈ 𝕌 n) (HB' : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A' γ), B' γ a ∈ 𝕌 n)
...
Proof.
  pose proof (sigmaTy_HO_inj1 n HA HB HA' HB' Hγ H) as HAA'.
  pose proof (sigmaTy_HO_inj2' n HA HB HA' HB' Hγ H) as HBB'.
...
Lemma pairTm_HO_typing {n : nat} {Γ : ZFSet} {A t u : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n)
...
Definition fstTm_HO (n : nat) (A : ZFSet -> ZFSet)
  (B : ZFSet -> ZFSet -> ZFSet) (t : ZFSet -> ZFSet) : ZFSet -> ZFSet :=
  fun γ => setFstSigma n (𝕌el n (A γ)) (fun a => 𝕌el n (B γ a)) (t γ).

Lemma fstTm_HO_typing {n : nat} {Γ : ZFSet} {A t : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n)
...
Definition sndTm_HO (n : nat) (A : ZFSet -> ZFSet)
  (B : ZFSet -> ZFSet -> ZFSet) (t : ZFSet -> ZFSet) : ZFSet -> ZFSet :=
  fun γ => setSndSigma n (𝕌el n (A γ)) (fun a => 𝕌el n (B γ a)) (t γ).

Lemma sndTm_HO_typing {n : nat} {Γ : ZFSet} {A t : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n)
...
Lemma sigmaTy_HO_β1 {n : nat} {Γ : ZFSet} {A t u : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n)
  (Ht : ∀ γ ∈ Γ, t γ ∈ 𝕌el n (A γ)) (Hu : ∀ γ ∈ Γ, u γ ∈ 𝕌el n (B γ (t γ))) :
...
Lemma sigmaTy_HO_β2 {n : nat} {Γ : ZFSet} {A t u : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n)
  (Ht : ∀ γ ∈ Γ, t γ ∈ 𝕌el n (A γ)) (Hu : ∀ γ ∈ Γ, u γ ∈ 𝕌el n (B γ (t γ))) :
...
Lemma sigmaTy_HO_η {n : nat} {Γ : ZFSet} {A t : ZFSet -> ZFSet} {B : ZFSet -> ZFSet -> ZFSet}
  (HA : ∀ γ ∈ Γ, A γ ∈ 𝕌 n) (HB : ∀ γ ∈ Γ, ∀ a ∈ 𝕌el n (A γ), B γ a ∈ 𝕌 n) (Ht : ∀ γ ∈ Γ, t γ ∈ 𝕌el n (sigmaTy_HO n A B γ)) :
